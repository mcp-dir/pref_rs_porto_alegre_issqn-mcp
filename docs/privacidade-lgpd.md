...
Prefeitura RS Porto Alegre: Comprovante de Inscrição do ISSQN segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_rs_porto_alegre_issqn@mcp.ai](mailto:pref_rs_porto_alegre_issqn@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
